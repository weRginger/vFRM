...
def PrintSummary(cache, optCache=None):
   ...
   print '|    Admin number: %d' % g.numAdmin
   print '|    Evict number: %d' % g.numEvict
   print '|    Evict dirty number: %d' % g.numEvictDirty
   ...
   outFile.write('Admin number: %d\n' % g.numAdmin)
   outFile.write('Evict number: %d\n' % g.numEvict)
   outFile.write('Evict dirty number: %d\n' % g.numEvictDirty)
